...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var yticks = otu_ids.slice(0, 10).map(number => `OTU ${number}`).reverse();
    console.log(yticks);
    ...
    var barLayout = {
      title: `Subject ${result.id} Top 10 Bacteria Cultures Found`
    ...
    var bubbleLayout = {
      title: `Subject ${result.id} Bacteria Cultures Per Sample`, 
      xaxis: { title: "OTU ID" },
      hovermode: 'closest'
    };
